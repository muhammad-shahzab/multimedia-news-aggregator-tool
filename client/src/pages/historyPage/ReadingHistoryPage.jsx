...
const ReadingHistoryPage = () => {
  ...
  useEffect(() => {
    const loadHistory = async () => {
      try {
        ...
        const response = await historyAPI.getHistory(); // No timeframe
  ...
  const handleBookmark = async (article) => {
    try {
      await bookmarksAPI.addBookmark({ articleId: article.articleId });
      showSnackbar("Bookmarked!", "success");
    } catch (err) {
      showSnackbar("Already bookmarked.", "warning");
    }
    handleMenuClose();
  };
  ...
  const handleRemoveFromHistory = async () => {
    ...
    try {
      ...
      showSnackbar("Removed from history.", "success");
    } catch (err) {
    ...
    <Box className={styles.pageContainer}>
      <Box className={styles.mainContent}>
        ...
        <Box className={styles.statsSection}>
          <Typography variant="h4" className={styles.statsTitle}>Reading History</Typography>
        ...
        {loadingHistory ? (
          ...
          <Card className={styles.emptyCard}>
            <CardContent className={styles.emptyCardContent}>
              ...
              <Typography variant="h6" className={styles.emptyTitle}>No history</Typography>
